...
import React, { createContext, useState, useContext, useMemo } from 'react';import { createTheme, ThemeProvider } from '@mui/material/styles';
                ...
                components: {
                    MuiButton: {
                        styleOverrides: {
                            ...
                            containedPrimary: {
                                color: '#fff',
                                '&:hover': {
                                    backgroundColor: mode === 'light' ? blueGrey[800] : amber[600],
                                },
                            },
                            containedSecondary: {
                                color: mode === 'light' ? blueGrey[800] : blueGrey[300],
                                '&:hover': {
                                    backgroundColor: mode === 'light' ? amber[600] : blueGrey[800],
                                },
                            },
                        },
                    },
                    ...
                    MuiTableContainer: {
                        styleOverrides: {
                            root: {
                                borderRadius: 8,
                                boxShadow: mode === 'light' ? '0px 2px 8px rgba(0, 0, 0, 0.1)' : 'none',
                                backgroundColor: mode === 'dark' ? '#424242' : undefined,
                            },
                        },
                    },
